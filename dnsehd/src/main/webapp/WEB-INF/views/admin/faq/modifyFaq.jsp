              ...
              <!-- Bootstrap Table with Caption -->
                  <div class="card mb-4">
                    ...
                    <div class="card-body row">
                      ...
                      <div class="mt-2">
                          <button type="submit" class="btn btn-outline-primary me-2"><a href="adFaq">수정하기</a></button>
                          <button type="reset" class="btn btn-outline-secondary"><a href="adFaq">뒤로가기</a></button>
                        </div>
                        </div>    
                      </form>
                    </div>
